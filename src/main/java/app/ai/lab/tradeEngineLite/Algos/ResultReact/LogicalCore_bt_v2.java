...
public class LogicalCore_bt_v2 {
    ...
    public LogicalCore_bt_v2(int instrumentId, String name, OrderManagementService oms, QuarterRecord record) {
    ...
    private void saveTradeLog(long start, long end, double pnl) {
        try {
            ...
            // Output path & write
            Path dir = Path.of("D:", "SpringBoot project", "Trade", "output files", "tradeInfo", "ResultReact_fut3", name);
